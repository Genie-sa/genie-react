...
Use a UI driver to reproduce user actions and verify what users see. Genie reads the React runtime
behind those actions. For a read-only inspection, you can call Genie directly.
