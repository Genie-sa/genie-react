...
Finish when the exact pathname and search match in both Router and browser history, the expected
content is visible, and focus is correct. Return to the original route if this was a temporary check.
