...
Report frame comparability and memory support separately. Proving heap growth needs repeated
equivalent flows and memory samples; one heap read is not a trend. React render counts alone
cannot establish frame pacing or memory growth.
